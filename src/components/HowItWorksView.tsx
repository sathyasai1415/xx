...
export function HowItWorksView() {
  return (
    <div className="w-full max-w-6xl mx-auto py-12 px-4">
      <h2 className="text-5xl font-black text-amber-400 mb-12 text-center tracking-tight drop-shadow-[0_0_15px_rgba(251,191,36,0.8)] uppercase">
        How It Works
      </h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
         {/* Video Card Fake */}
         <div className="bg-[#111118] border border-amber-500/30 rounded-[2rem] overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.8)] group transition-transform hover:-translate-y-2">
            <div className="relative h-64 bg-black flex items-center justify-center overflow-hidden">
               ...
               <button className="w-20 h-20 bg-amber-500/90 hover:bg-amber-400 rounded-full flex items-center justify-center text-black font-black absolute z-10 transition-colors shadow-[0_0_20px_rgba(251,191,36,0.5)]">
                 <Play className="w-8 h-8 ml-2" />
               </button>
            </div>
            <div className="p-8">
               <h3 className="text-2xl font-black text-amber-300 mb-4 tracking-wide">1. Build Your Craving</h3>
      ...
      <div className="bg-gradient-to-br from-red-900/50 to-[#0A0A0F] border border-red-500/30 p-10 rounded-[3rem] text-center shadow-[0_0_40px_rgba(232,0,45,0.2)]">
         ...
         <p className="text-2xl font-bold text-stone-200 uppercase tracking-widest leading-loose">
           No hidden fees. <span className="text-green-400">Stores win.</span> <span className="text-amber-400">Users win.</span>
         </p>
