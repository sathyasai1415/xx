...
const DotField = memo(({
  ...
  const { dotRadius: _dr, dotSpacing: _ds, cursorRadius: _cr, cursorForce: _cf, bulgeOnly: _bo, bulgeStrength: _bs, glowRadius: _gr, sparkle: _sp, waveAmplitude: _wa, gradientFrom: _gf, gradientTo: _gt, glowColor: _gc, ...divRest } = rest;

  return (
    <div className="dot-field-container" {...divRest}>
      <canvas
        ref={canvasRef}
